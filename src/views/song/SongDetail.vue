            ...
            <v-row justify="center">
              ...
              <v-col cols="12" md="6">
                ...
                <song-manage-item
                  ...
                  icon="mdi-midi"
                  fileType=".mid"
                  placeholder="อัปโหลดไฟล์ midi ระดับง่าย"
                ...
                <!-- <song-manage-item
                  ...
                  icon="mdi-midi"
                  fileType=".mid"
                  placeholder="อัปโหลดไฟล์ midi ระดับปานกลาง"
                  @onFileSelected="file = { ...file, ...$event }"
                  @onDeleted="refresh"
                /> -->
                ...
                <song-manage-item
                  ...
                  icon="mdi-midi"
                  fileType=".mid"
                  placeholder="อัปโหลดไฟล์ midi ระดับยาก"
                  @onFileSelected="file = { ...file, ...$event }"
                  @onDeleted="refresh"
                />
    ...
    async save() {
      ...
      try {
        ...
        if (this.imageToUpload) {
          this.statusMessage = "กำลังอัปโหลดหน้าปก...";
        ...
        if (Object.keys(this.file).length > 0) {
          this.statusMessage = "กำลังอัปโหลดเพลง...";
